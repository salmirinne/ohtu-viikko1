...
public class KauppaTest {
    ...
    @Test
    public void loppuneenTuotteenOstoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanOikein() {
        // määritellään että viitegeneraattori palauttaa viitten 42
        when(viite.uusi()).thenReturn(42);
    ...
    public void aloitaAsiointiNollaaEdellisenOstoksenTiedot() {
        ...
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        when(varasto.saldo(2)).thenReturn(10);
        when(varasto.haeTuote(2)).thenReturn(new Tuote(1, "kalja", 100));
        ...
        k.lisaaKoriin(2);
        k.tilimaksu("pekka", "12345");
        verify(pankki).tilisiirto(eq("pekka"), anyInt(), eq("12345"), anyString(), eq(100));
    }
    ...
    public void kauppaPyytaaUudenViitteenJokaiselleMaksutapahtumalle() {
        ...
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.tilimaksu("pekka", "12345");
        verify(pankki).tilisiirto(eq("pekka"), eq(11), eq("12345"), anyString(), eq(5));
        
        k.aloitaAsiointi();
        k.lisaaKoriin(2);
        k.tilimaksu("pekka", "12345");
        verify(pankki).tilisiirto(eq("pekka"), eq(12), eq("12345"), anyString(), eq(100));
    }
    
    @Test
    public void tuotteenPoistaminenOstoskoristaVahentaaSummasta() {
        // määritellään että viitegeneraattori palauttaa viitten 42
        ...
        k.poistaKorista(1);
        k.tilimaksu("pekka", "12345");
        verify(pankki).tilisiirto(eq("pekka"), eq(11), eq("12345"), anyString(), eq(10));
    }
