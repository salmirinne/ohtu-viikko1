...
public abstract class WebKauppaServlet extends HttpServlet {
    ...
    protected Komentotehdas komennot = new Komentotehdas();
    ...
    public WebKauppaServlet() {
        varasto = new Varasto(TuoteDAO.inMemory());
        pankki = new PankkiFasaadi();
        toimitusjarjestelma = new ToimitusjarjestelmaFasaadi();
    }     

    public WebKauppaServlet(Varasto varasto, PankkiFasaadi pankki, ToimitusjarjestelmaFasaadi toimitusjarjestelma) {
